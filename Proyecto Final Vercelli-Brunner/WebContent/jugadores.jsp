...
<html>
	...
	<body>
		<div id="contenedor">
			...
			<div id="contenedor2">
				<section>
					<div id="titJugadores">Jugadores</div>
					<% 
						for(int i=0; i<3; i++)
						{
					%>
						<div id="jugadores">
							<table id="tablaPartidosDisponibles">
								<tr><td>Nombre: </td><td>Juan Franco Emanuel</td></tr>
								<tr><td>Apellido: </td><td>Vercelli</td></tr>
								<tr><td>Fecha Nacimento: </td><td>08/12/1992</td></tr>
								<tr><td>Equipo: </td><td>LeoFran</td></tr>
							</table>
						</div>
